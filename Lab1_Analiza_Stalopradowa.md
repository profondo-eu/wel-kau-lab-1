...
![Rezystor między węzłami i oraz j](img/lab1_01_rezystor_ij.png)
...
![Rezystor do masy](img/lab1_02_rezystor_masa.png)
...
![Źródło prądowe](img/lab1_03_zrodlo_pradowe.png)
...
![Źródło napięciowe](img/lab1_04_zrodlo_napieciowe.png)
...
- Węzły: **3** (węzeł 1, 2, 3) — masę (węzeł 0) nie liczymy, bo jest odniesnikiem
- Źródeł napięciowych: **0** → nie potrzebujemy MNA!
- **Wymiar macierzy: 3 × 3** — bo mamy 3 niewiadome (V1, V2, V3) i 3 równania (KCL dla każdego węzła)

> **Skąd wymiar?** Każdy węzeł (poza masą) daje jedną niewiadomą (potencjał)
> i jedno równanie (prawo Kirchhoffa — suma prądów = 0). Masa ma potencjał 0V
> z definicji, więc nie jest niewiadomą. Stąd: **n węzłów → macierz n × n**.
...
![Dzielnik napięcia: V1, R1, R2](img/lab1_05_dzielnik.png)
...
![Dwa źródła napięciowe — sprzeczność](img/lab1_06_dwa_zrodla.png)
...
![Obwód ze źródłem prądowym](img/lab1_07_zrodlo_pradowe_obwod.png)
...
![Charakterystyka I-V diody](img/lab1_dioda_iv.png)
...
![Linearyzacja — styczna do krzywej I-V](img/lab1_linearyzacja.png)
...
![Metoda Newtona-Raphsona — wizualizacja graficzna](img/lab1_newton_raphson.png)
...
|:---:|:---:|
| ![Dioda](img/lab1_08_obwod_dioda.png) | ![Model zastępczy diody](img/lab1_09_model_zastepczy_diody.png) |
...
![Obwód z diodą](img/lab1_08_obwod_dioda.png)
...
![Zbieżność kwadratowa N-R](img/lab1_zbieznosc_NR.png)
...
![Obwód RC do porównania .NODESET/.IC](img/lab1_10_rc_nodeset_ic.png)
...
![Porównanie .NODESET vs .IC](img/lab1_nodeset_vs_ic.png)
